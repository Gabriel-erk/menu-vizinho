...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.layout','data' => ['title' => 'Mr.Burger - Login']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Mr.Burger - Login']); ?>
    ...
    <div class="p-3">
        ...
        <p class="mt-4 text-center">Ainda não possui uma conta?<a href="<?php echo e(route('cadastro')); ?>">Registre-se</a></p>
...
<?php endif; ?>
<?php /**PATH C:\dev\menu-vizinho\menu-vizinho\resources\views/login.blade.php ENDPATH**/ ?>